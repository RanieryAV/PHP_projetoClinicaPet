...
} else if (isset($_POST['nomeCliente']) && $_POST['nomeCliente'] != "" ){
    echo "nome: <br>";echo $_POST['nomeCliente'];
    $objCliente->selecionarPorNome($_POST['nomeCliente']);
}else if (isset($_POST['cpfCliente']) && $_POST['cpfCliente'] != "") {
    echo "cpf: <br>";echo $_POST['cpfCliente'];
